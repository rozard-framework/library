...
/** SINGLE SERIES  */
    ...
    function pure_date( string $datum ) {
        $datum = preg_replace('([^0-9-])', '', $datum);
        return $datum;
    }

    function pure_time( string $datum ) {
        $datum = preg_replace('([^0-9:])', '', $datum);
        return $datum;
    }

    function pure_week( string $datum ) {
        $datum = preg_replace('([^0-9-W])', '', $datum);
        return $datum;
    }

    function pure_phone( string $datum ) {
        $datum = preg_replace('([^0-9-+])', '', $datum);
        return $datum;
    }

    function pure_datetime( string $datum ) {
        $datum = preg_replace('([^0-9-T:])', '', $datum);
        return $datum;
    }
