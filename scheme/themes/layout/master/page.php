...
if ( ! class_exists( 'rozard_theme_page' ) ) {


    class rozard_theme_page{
        ...
        private function base() {
            ...
            printf ('<div class="%s page">', esc_attr( $model ) );
        ...
        private function lside() {
            do_action( 'page_left_sidebar' );
        }


        private function rside() {
            do_action( 'page_right_sidebar' );
        }


        private function pages() {

            printf( '<article id="page">' );
                $this->title();
                $this->content();
            printf( '</article>' );
        }
        ...
        private function title() {
            ...
            printf ( '<div class="metadata">' );
                ...
                do_action( 'before_page_title_core' );
                ...
                do_action( 'after_page_title_core' );
